...
BEGIN
	SELECT vuelo.idVuelo Vuelo, company.nombre Compañia, A1.nombre Aeropuerto_Origen, A2.nombre Aeropuerto_Destino, avion.modelo Modelo_Avion, TV.Tipo Tipo_de_Vuelo
